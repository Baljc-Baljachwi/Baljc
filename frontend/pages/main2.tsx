  ...
  return (
    <Wrapper>
      ...
      <Container ref={heightRef}>
        <NavbarWrapper>{/* <Navbar children={null} /> */}</NavbarWrapper>
        <MobileLogoWrapper>{/* <MainLogo /> */}</MobileLogoWrapper>
        <Contents>
          {/* <Description />
          <Balloon>
          ...
          <AvatarWrapper>{/* <PeopleAvatar /> */}</AvatarWrapper>
        </Contents>
