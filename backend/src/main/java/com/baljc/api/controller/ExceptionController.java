...
public class ExceptionController {
    ...
    public ResponseEntity<BaseResponse> MalformedJwtExceptionHandler(MalformedJwtException e) {
        ...
        // 401
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new BaseResponse(2100, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> ExpiredJwtExceptionHandler(ExpiredJwtException e) {
        ...
        // 401
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new BaseResponse(2101, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> UnsupportedJwtExceptionHandler(UnsupportedJwtException e) {
        ...
        // 401
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new BaseResponse(2102, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> BadCredentialsExceptionHandler(BadCredentialsException e) {
        ...
        // 401
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new BaseResponse(2103, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> UnauthenticatedMemberExceptionHandler(UnauthenticatedMemberException e) {
        ...
        // 401
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new BaseResponse(2104, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> UsernameNotFoundExceptionHandler(UsernameNotFoundException e) {
        ...
        // 404
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new BaseResponse(2400, e.getMessage()));
    }
    ...
    public ResponseEntity<BaseResponse> JsonProcessingExceptionHandler(JsonProcessingException e) {
        ...
        //500
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new BaseResponse(2900, e.getMessage()));
    }
}
